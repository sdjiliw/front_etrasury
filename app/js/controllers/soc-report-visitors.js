(function() {
    ...
    app.controller('EcommerceAdmissionsCtrl', ['$scope', '$timeout', function($scope, $timeout) {
        ...
        $scope.colours = [{ // grey
                fillColor: "rgba(122,106,147,0.8)",
                strokeColor: "#7a6a93",
                pointColor: "#7a6a93",
                pointStrokeColor: "#fff",
                pointHighlightFill: "#fff",
    ...
    app.controller('EcommerceStudentActivityCtrl', function($scope) {
        $scope.labels = ['Browsing', 'Networking', 'Advertising', 'Sharing', 'Chatting', 'Posting'];
